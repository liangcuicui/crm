										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<TD>客户电话：</TD>
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="cust_phone" value="<s:property value="%{model.cust_phone}"/>">
													</TD>
													<TD>客户手机：</TD>
													<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="cust_mobile" value="<s:property value="%{model.cust_mobile}"/>">
													</TD>
									...
									<TD><SPAN id=pagelink>
											<DIV style="LINE-HEIGHT: 20px; HEIGHT: 20px; TEXT-ALIGN: right">
												...
												<select name="pageSize" onchange="to_page()">
													...
													<option value="7" <s:if test="pageSize==5">selected</s:if>>7</option>
												</select>
												条
